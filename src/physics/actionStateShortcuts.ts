...
// Global Interrupts
export function checkForSmashes (p,input): [boolean, string | false] {
  if (input[p][0].a && !input[p][1].a){
...
export function checkForTilts (p,input,reverse=1): [boolean, string | false] {
  if (input[p][0].a && !input[p][1].a) {
...
export function checkForIASA(p,input,isAerial): boolean {
...
export function checkForSpecials (p,input): [boolean, string | false] {
...
export function checkForAerials (p,input): [boolean, string | 0]{
  //console.log(p);
  //console.log(input);
  //console.log(input[p]);
...
export function checkForJump (p,input): [boolean, number | false] {
  if ((input[p][0].x && !input[p][1].x) || (input[p][0].y && !input[p][1].y)) {
    return [true, 0];
  }   else if (gameSettings["tapJumpOffp" + (p + 1)] == false && (input[p][0].lsY > 0.66 && input[p][3].lsY < 0.2)) { // == is on purpose
    return [true, 1];
  } else {
    return [false, false];
  }
...
export const actionStates: {
  ...
  [key: number] :{
    ...
    "THROWNPUFFUP": State
    "ATTACKAIRD": State
    "CLIFFGETUPQUICK": State
    "DOWNSPECIALAIRSTART": State
    "DOWNSPECIALAIRLOOP": State
    "DOWNSPECIALAIREND": State
    "DOWNSPECIALAIRTURN": State
    "DOWNSPECIALAIRREFLECT": State
    "FIREFOXBOUNCE": State
    "JUMPF": State
    "REBOUND": State
    "TECHN": State
    ...
    "DOWNSPECIALGROUNDTURN": State
    "DOWNSPECIALGROUNDREFLECT": State
    "FORWARDSMASH": State
    "KNEEBEND": State
    "RUN": State
    "TECHU": State
    ...
    "DOWNSTANDN": State
    "FURASLEEPEND": State
    "LANDINGATTACKAIRD": State
    "SHIELDBREAKDOWNBOUND": State
    "THROWFORWARD": State
    "UPSPECIALLAUNCH": State
    "CAPTURECUT": State
    "DAMAGEFALL": State
    "DOWNTILT": State
    "FURASLEEPLOOP": State
    "LANDINGATTACKAIRF": State
    "SHIELDBREAKFALL": State
    "THROWNFOXBACK": State
    "UPTILT": State
    "CAPTUREDAMAGE": State
    "DAMAGEFLYN": State
    "DOWNWAIT": State
    "FURASLEEPSTART": State
    "LANDINGATTACKAIRN": State
    "SHIELDBREAKSTAND": State
    "THROWNFOXDOWN": State
    "WAIT": State
    "CAPTUREPULLED": State
    "DAMAGEN2": State
    "ENTRANCE": State
    "GRAB": State
    "LANDINGATTACKAIRU": State
    "SIDESPECIALAIR": State
    "THROWNFOXFORWARD": State
    "WALK": State
    "CAPTUREWAIT": State
    "DASH": State
    "ESCAPEAIR": State
    "GUARD": State
    "LANDINGFALLSPECIAL": State
    "SIDESPECIALGROUND": State
    "THROWNFOXUP": State
    "WALLDAMAGE": State
    "CATCHATTACK": State
    "DEADDOWN": State
    ...
    "MISSFOOT": State
    "SLEEP": State
    "THROWNMARTHBACK": State
    "WALLJUMP": State
    "CATCHCUT": State
    "DEADLEFT": State
    "ESCAPEF": State
    "GUARDON": State
    "NEUTRALSPECIALAIR": State
    "SMASHTURN": State
    "THROWNMARTHDOWN": State
    "WALLTECH": State
    "CATCHWAIT": State
    "DEADRIGHT": State
    "ESCAPEN": State
    "JAB1": State
    "NEUTRALSPECIALGROUND": State
    "SQUAT": State
    "THROWNMARTHFORWARD": State
    "WALLTECHJUMP": State
    "CLIFFATTACKQUICK": State
    "DEADUP": State
    "JAB2": State
    "OTTOTTO": State
    "SQUATRV": State
    "THROWNMARTHUP": State
    "CLIFFATTACKSLOW": State
    "DOWNATTACK": State
    "JAB3": State
    "OTTOTTOWAIT": State
    "SQUATWAIT": State
    "THROWNPUFFBACK": State
    "CLIFFCATCH": State
    "DOWNBOUND": State
    "FALL": State
    "JUMPAERIALB": State
    "PASS": State
    "STOPCEIL": State
    "THROWNPUFFDOWN": State
    "CLIFFESCAPEQUICK": State
    "DOWNDAMAGE": State
    "FALLAERIAL": State
    "JUMPAERIALF": State
    "REBIRTH": State
    "TECHB": State
    "THROWNPUFFFORWARD": State
    "THROWNFALCOBACK": State
    "THROWNFALCODOWN": State
    "THROWNFALCOFORWARD": State
    "THROWNFALCOUP": State
    "THROWNFALCONBACK": State
    "THROWNFALCONDOWN": State
    "THROWNFALCONFORWARD": State
    "THROWNFALCONUP": State
    "APPEAL": State
    "THROWNFALCONDIVE": State
  }
} = [];
