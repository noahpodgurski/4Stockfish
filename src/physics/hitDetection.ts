...
export let hitQueue: any[] = [];
export function resetHitQueue(){
  hitQueue =[];
}
export let phantomQueue: any[] = [];
...
export function interpolatedHitHurtCollision (i,p,j,phantom=false){
...
export function hitHurtCollision (i,p,j,previous,phantom=false){
