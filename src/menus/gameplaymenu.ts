...
export function gameplayMenuControls (i, input){
  ...
  if (input[i][0].b && !input[i][1].b) {
    ...
    switch (menuIndex[0]) {
      case 0:
        gameSettings.turbo = !gameSettings.turbo;
        break;
      case 1:
        ...
        break;
      case 2:
        gameSettings.flashOnLCancel = !gameSettings.flashOnLCancel;
        break;
      case 3:
        gameSettings.everyCharWallJump = !gameSettings.everyCharWallJump;
        break;
      case 4:
        gameSettings["tapJumpOffp" + (menuIndex[1] + 1)] = !gameSettings["tapJumpOffp" + (menuIndex[1] + 1)];
      default:
        break;
    }
