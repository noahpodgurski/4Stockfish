...
export type Line = [Vec2D, Vec2D];
type Polygon = Array<Vec2D>;


export function intersectsAny(newLine: Line, lines: Array<Line>):boolean {
...
function intersects(line1: Line, line2: Line):boolean {
...
function isInside( point : Vec2D, lines : Array<Line>) :boolean {
...
function evenNumberOfTrue(list: Array<boolean>):boolean {
  if (list.length < 1) {
    return true;
  }
  else {
