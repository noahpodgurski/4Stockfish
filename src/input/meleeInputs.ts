...
function unitRetract ( [x, y] ) : [number, number] {
...
export function tasRescale ( x: number, y: number, isDeadzoned: boolean = false) : [number, number] {
