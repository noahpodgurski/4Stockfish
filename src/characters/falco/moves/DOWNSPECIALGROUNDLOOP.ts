/* eslint-disable */
import DOWNSPECIALGROUNDEND from "./DOWNSPECIALGROUNDEND";
import DOWNSPECIALGROUNDTURN from "./DOWNSPECIALGROUNDTURN";
...
const DOWNSPECIALGROUNDLOOP: State = {
...
export default DOWNSPECIALGROUNDLOOP;