/* eslint-disable */
import DOWNSPECIALAIREND from "./DOWNSPECIALAIREND";
import DOWNSPECIALAIRTURN from "./DOWNSPECIALAIRTURN";
...
const DOWNSPECIALAIRLOOP: State = {
...
export default DOWNSPECIALAIRLOOP;