...
exports.startControllerInfoBox = startControllerInfoBox;
exports.renderControllerInputLight = renderControllerInputLight;
const domCIBContainer = document.getElementById("controllerInfoBoxContainer");
function startControllerInfoBox() {
    ...
    for (i = 0; i < gamepads.length; i++) {
        ...
        domCIBContainer === null || domCIBContainer === void 0 ? void 0 : domCIBContainer.insertAdjacentHTML('beforeend', '<div id="cib' + i + '" class="controllerInfoBox"><div class="cibInput"><div class="cibInputTitle"><p>Input</p></div><div id="cibL' + i + '" class="cibInputLight"></div></div><div class="cibName"><p class="cibNameBig">Mayflash</p><p class="cibNameSmall">' + gamepad.id + '</p></div><div class="cibPrompt"><p id="cibPromptEdit' + i + '">Ready</p></div></div>');
    }
    if (i === 0) {
        domCIBContainer === null || domCIBContainer === void 0 ? void 0 : domCIBContainer.insertAdjacentHTML('beforeend', '<div id="noControllerPrompt"><p>No Controllers Detected</p></div>');
    }
}
function renderControllerInputLight() {
    const gamepads = navigator.getGamepads();
    let cibLight;
    let foundInput;
    let colour;
