...
exports.tigergame2 = exports.tigergame1 = void 0;
const defaults_1 = require("../defaults");
exports.tigergame1 = { a: { kind: "pressed", index: 0 },
    ...
    cs: { kind: "axes", xIndex: 2, yIndex: 3, cardinals: defaults_1.gamecubeCardinals },
    isGC: true,
...
exports.tigergame2 = { a: { kind: "pressed", index: 0 },
    b: { kind: "pressed", index: 1 },
    x: { kind: "pressed", index: 2 },
    y: { kind: "pressed", index: 3 },
    z: { kind: "pressed", index: 6 },
